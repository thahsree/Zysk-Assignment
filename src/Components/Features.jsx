...
const Features = () => {
  return (
    <div className="w- flex py-[96px] gap-[64px] h-[836px] items-center flex-col overflow-hidden">
      <div className="px-[32px] flex gap-[32px] h-[160px] justify-center">
        <div className="flex gap-[48px] h-[160px] w-[1216px]  justify-center">
          <div className="w-[768px] h-[160px] flex gap-[20px] flex-col items-center">
            <div className="flex gap-[12px] w-[768px] h-[80px] flex-col">
            ...
            <p className="text-center w-[768px] text-[#475467]">
      ...
      <div className="flex flex-wrap gap-[64px]">
        <div className="flex gap-[32px] flex-col items-center">
          ...
          <div className="flex flex-col gap-[8px] items-center">
            ...
            <p className="text-[#475467] font-normal text-[16px] leading-[24px] text-center w-[384px]">
